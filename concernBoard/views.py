...
class BoardPostListView(generics.ListAPIView):
    def get_queryset(self):
        board_contents = BoardConcern.objects.values(
            'board_id',
            'title',
            'creationdate',
            'user__name',
...
class BoardPostView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        queryset = BoardConcern.objects.filter(board_id=board_id).values(
            'board_id',
            'title',
            'contents',
            'creationdate',
...
class BoardPostCommentView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        board_id = self.kwargs['pk']
        queryset = CommentsConcern.objects.filter(board=board_id).values(
            'contents',
            'creationdate',
            'user__name',
            'comment_id',
...
class BoardSearchView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        if self.kwargs['searchfield'] == 'title':
            ...
            queryset = BoardConcern.objects.filter(title__contains=self.kwargs['searchkeyword']).values(
                'board_id',
                'title',
                'creationdate',
                'user__name',
            ...
            queryset = BoardConcern.objects.filter(contents__contains=self.kwargs['searchkeyword']).values(
                'board_id',
                'title',
                'creationdate',
                'user__name',
            ...
            queryset = BoardConcern.objects.filter(user__name__contains=self.kwargs['searchkeyword']).values(
                'board_id',
                'title',
                'creationdate',
                'user__name',
...
class BoardPostUpdateView(generics.UpdateAPIView):#PATCH method
    ...
    queryset = BoardConcern.objects.all()
...
class BoardPostCommentCreateView(generics.CreateAPIView):
    ...
    def perform_create(self, serializer):
        user_instance = User.objects.get(name=serializer.validated_data.get('name', ''))
        board_id = BoardConcern.objects.get(board_id=self.kwargs['pk'])
        
        CommentsConcern.objects.create(
            contents=serializer.validated_data['contents'],
            user=user_instance,
            board=board_id,
        )
...
class BoardPostCommentUpdateView(generics.UpdateAPIView):#PATCH method
    ...
    queryset = CommentsConcern.objects.all()
